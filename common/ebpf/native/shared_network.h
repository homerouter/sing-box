...
enum sb_shared_stat {
    SB_SHARED_STAT_TOKEN_RESERVATION_FAILED,
    SB_SHARED_STAT_BYPASS_CACHE_UPDATE_FAILED,
    SB_SHARED_STAT_PACKET_REWRITE_FAILED,
    SB_SHARED_STAT_SCRATCH_LOOKUP_FAILED,
    SB_SHARED_STAT_IPV6_TRANSPORT_PARSE_FAILED,
