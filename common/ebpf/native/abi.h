...
enum sb_ebpf_cgroup_stat {
    SB_EBPF_CGROUP_STAT_REDIRECT_RESERVATION_FAILED,
    SB_EBPF_CGROUP_STAT_CONNECTED_UDP_STATE_FAILED,
    SB_EBPF_CGROUP_STAT_UDP_FLOW_UPDATE_FAILED,
    SB_EBPF_CGROUP_STAT_UDP_PEER_UPDATE_FAILED,
    SB_EBPF_CGROUP_STAT_COUNT,
};
